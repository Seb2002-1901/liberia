...
export default function DesignMatchParametresV3() {
  return (
    <>
      <style>{`
      ...
      >
        ...
        <div data-par-content style={{ marginLeft: 248, flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
          <Topbar />
          <main
            data-par-main
            style={{
    ...
    >
      ...
      <nav style={{ flex: 1, overflowY: "auto", padding: "0 10px" }}>
        ...
        <NavSection title="PLUS">
          <NavItem label="Paramètres" iconPath="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" active />
