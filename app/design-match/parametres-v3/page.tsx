 ...
 *
 * Cette page V3 (`parametres-v3`) était une maquette statique sans
 ...
 *
 * Cible : `/settings` (page prod fonctionnelle).
 */
import { redirect } from "next/navigation";

export default function ParametresV3RedirectPage(): never {
  redirect("/settings");
}
