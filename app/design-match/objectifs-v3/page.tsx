...
export default function DesignMatchObjectifsV3() {
  return (
    <>
      <style>{`
      ...
      >
        ...
        <div data-obj-content style={{ marginLeft: 248, flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
          <Topbar />
          <main
            data-obj-main
            style={{
    ...
    >
      ...
      <nav style={{ flex: 1, overflowY: "auto", padding: "0 10px" }}>
        ...
        <NavSection title="FINANCES">
          ...
          <NavItem label="Objectifs" iconPath="M4 15s1-1 4-1 5 2 8 2 4-1 4-1V3s-1 1-4 1-5-2-8-2-4 1-4 1z|M4 22V15" active />
        </NavSection>
