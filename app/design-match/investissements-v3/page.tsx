 ...
 *
 * Cette page V3 (`investissements-v3`) était une maquette statique sans
 ...
 *
 * Cible : `/investments` (page prod, stub ComingSoon pour le moment).
 */
import { redirect } from "next/navigation";

export default function InvestissementsV3RedirectPage(): never {
