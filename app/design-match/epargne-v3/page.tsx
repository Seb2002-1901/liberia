...
export default function DesignMatchEpargneV3() {
  return (
    <>
      <style>{`
      ...
      >
        ...
        <div data-epa-content style={{ marginLeft: 248, flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
          <Topbar />
          <main
            data-epa-main
            style={{
    ...
    >
      ...
      <nav style={{ flex: 1, overflowY: "auto", padding: "0 10px" }}>
        ...
        <NavSection title="CROISSANCE">
          <NavItem label="Épargne" iconPath="M21 11h-1a4 4 0 0 0-4-4h-4a8 8 0 0 0-8 8 6 6 0 0 0 6 6h2v-3h4v3h2a6 6 0 0 0 4-2v-2h2v-6z" active />
