 ...
 *
 * Cette page V3 (`opportunites-v3`) était une maquette statique sans
 ...
 *
 * Cible : `/opportunities` (page prod, stub ComingSoon pour le moment).
 */
import { redirect } from "next/navigation";

export default function OpportunitesV3RedirectPage(): never {
