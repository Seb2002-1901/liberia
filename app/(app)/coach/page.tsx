/**
 * /coach — Coach IA (welcome / landing).
 *
 * Cette page sert de WELCOME pour le coach :
 *   - si l'utilisateur a déjà une conversation → redirect vers
 *     /coach/{firstConversationId}.
 ...
 * priorité du moment (buildFirstMission). Aucun mock visible comme réel —
 * le thread vide affiche un empty state explicite.
 */
